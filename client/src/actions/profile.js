...
import { GET_PROFILE, GET_PROFILE_FAILURE, UPDATE_PROFILE, UPDATE_PROFILE_FAILURE, CLEAR_PROFILE, DELETE_ACCOUNT, GET_PROFILES, GET_PROFILES_FAILURE } from './types'
...
export const addEducation = (formData, history, edit = false) => async dispatch => {
    try {
        ...
        dispatch(setAlert(edit ?'Education Updated' : 'Education Created', 'success'))
